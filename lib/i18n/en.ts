...
export const en: Dictionary = {
  ...
  report: {
    ...
    patternsHeading: "Pattern Summary",
    noIncidents: "No incidents in this range.",
    noPatterns: "No patterns detected in this range.",
    footer: "Generated by Witness Protocol",
    signatureLine: "Signature",
    optionsTitle: "Report Options",
    dateFrom: "From date",
    dateTo: "To date",
    categoriesLabel: "Categories to include",
    allCategories: "All categories",
    includeEvidence: "Include evidence list",
    formatLabel: "Format",
    formatPlainText: "Plain text (.txt)",
    formatRichText: "Rich text (print/PDF)",
